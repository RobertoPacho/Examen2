...
a persistence unit "PachoRobertoSriJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PachoRobertoSriJEE\pom.xml":
...
artifact ("PachoRobertoSriJEE.war") is already built. You can build
