...
a persistence unit "PachoRobertoOperadorJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PachoRobertoOperadorJEE\pom.xml":
...
artifact ("PachoRobertoOperadorJEE.war") is already built. You can build
