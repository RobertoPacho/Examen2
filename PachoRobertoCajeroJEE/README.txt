...
a persistence unit "PachoRobertoCajeroJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PachoRobertoCajeroJEE\pom.xml":
...
artifact ("PachoRobertoCajeroJEE.war") is already built. You can build
